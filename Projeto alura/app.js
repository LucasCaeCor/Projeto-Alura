document.getElementById('search-form').addEventListener('submit', function(e) {
    ...
    const stars = [
        ...
        { name: 'Antares', description: 'A estrela mais brilhante na constelação de Escorpião, uma supergigante vermelha.', image: 'https://revistaplaneta.com.br/wp-content/uploads/sites/3/2017/10/1_pl535_volta-ao-mundo13.jpg', link: 'https://pt.wikipedia.org/wiki/Antares' },
